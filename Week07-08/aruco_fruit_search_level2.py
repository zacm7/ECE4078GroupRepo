...
# # Helpers and planner
# from map_utils import read_true_map_robust, load_search_list, print_target_fruits_pos, build_targets_and_obstacles
...
#         super().__init__(args)
#         self.waypoints = waypoints[:]  # planned path
...
#     operate = AutoOperatePlan(op_args, waypoints)
